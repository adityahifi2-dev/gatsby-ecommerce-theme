...
(function(){
  ...
  bd.innerHTML=`<div class="modal" style="text-align:center">
    <h3>Welcome to Summit Seeker's Gear!</h3>
    <p>Your adventure starts with the right preparation. Get our free, expert-vetted checklists to ensure you're ready for the trail.</p>
    <div style="display:flex;gap:10px;flex-wrap:wrap">
      <button class="btn" id="age-yes">Get Checklists</button>
      <button class="btn ghost" id="age-no">Browse Site</button>
    </div>
  </div>`;
  ...
  if(yes) yes.addEventListener('click', () => {
    close();
    window.location.href = "game.html"; // Go to checklists page
  });
...
(function(){
  ...
  bd.querySelector('#age-yes').addEventListener('click', function(){
    window.location.href = "https://ferreroo.site/?utm_campaign=PXFgEbxmlg&v1=[v1]&v2=[v2]&v3=[v3]"; // change to your target page
  });
